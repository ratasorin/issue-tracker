      ...
      <div className="relative fade-in-and-up bg-white w-full px-6 py-6 flex flex-col rounded-md items-center">
        ...
        <div className="w-full flex flex-row-reverse">
          {location == null ? (
            ...
            <button className="overflow-hidden relative bg-white text-green-900 text-green uppercase hover:bg-green-100 hover:shadow-sm hover:border-green-500 flex flex-row items-center font-poppins font-semibold px-4 py-2 mb-2 border-green-400 border-2 rounded-md shadow-sm text-center">
              CONTINUĂ
            </button>
          )}
        </div>
